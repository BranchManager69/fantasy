...
export default async function Home({
  ...
  return (
    <main className="shell">
      <AppNav />
      <p style={{ marginBottom: 24, maxWidth: 760, color: "var(--text-soft)" }}>
        Season odds use a simple projection model with fixed uncertainty. Early-season
        player history is limited; treat these percentages as exploratory estimates.
        <a href="/" style={{ marginLeft: 8, textDecoration: "underline" }}>View verified weekly results.</a>
      </p>
      <section
